...
@Component({
  selector: 'app-registration-cc-conta-conectcar',
  templateUrl: './cc-conta-conectcar.component.html',
  styleUrls: ['./cc-conta-conectcar.component.less'],
  encapsulation: ViewEncapsulation.None,
  animations: [ Animations.slideInOut ]
})
export class ComoFuncionaContaConectcarComponent implements OnInit, AfterViewInit {
